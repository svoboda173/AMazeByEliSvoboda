...
import edu.wm.cs.cs301.EliSvoboda.generation.BSPBranch;
import edu.wm.cs.cs301.EliSvoboda.generation.BSPLeaf;
import edu.wm.cs.cs301.EliSvoboda.generation.BSPNode;
import edu.wm.cs.cs301.EliSvoboda.generation.Floorplan;
import edu.wm.cs.cs301.EliSvoboda.generation.Wall;
...
public class FirstPersonView {
	...
	public void draw(MazePanel panel, int x, int y, int walkStep, int ang, float percentToExit) {
        ...
        g.setColor(ColorTheme.getColor(MazeColors.FIRSTPERSON_DEFAULT).toArgb());
